...
namespace HashBreaker
{
    public class MD4 : HashAlgorithm
    {
        ...
        {
            for (int i = offset; i < length; i++) yield return bytes[i];
        }
